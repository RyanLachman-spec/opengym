...
const P = {
  ...
  apple: <><path d="M12 8.2c-3.4-2.6-7.6-.4-7.6 4.4 0 4.4 3.2 8.4 6 8.4.9 0 1.3-.4 1.6-.4.3 0 .7.4 1.6.4 2.5 0 5.2-3.1 5.8-6.8.5-3-1-5.8-3.6-6-1.1-.1-2.4.4-3 1" /><path d="M12 8.2c.2-1.8 1.4-3.4 3-3.8" /></>,
  barcode: <path d="M4 4.4v15.2M7.2 4.4v15.2M9.6 4.4v15.2M12 4.4v15.2M14.8 4.4v15.2M17.2 4.4v15.2M20 4.4v15.2" />,
  camera: <><path d="M4.4 8.2a1.8 1.8 0 0 1 1.8-1.8h1.6l1-1.8h6.4l1 1.8h1.6a1.8 1.8 0 0 1 1.8 1.8v9a1.8 1.8 0 0 1-1.8 1.8H6.2a1.8 1.8 0 0 1-1.8-1.8Z" /><circle cx="12" cy="13" r="3.4" /></>,
}
