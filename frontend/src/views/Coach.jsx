...
const CATEGORY_TEXT = {
  ...
  training: ['Your logged training', 'Sets you logged in the review window — weights, reps, times, effort ratings, how long sessions took, and any sore spots you marked afterwards.'],
