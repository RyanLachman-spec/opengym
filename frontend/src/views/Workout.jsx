  ...
  return <>
    ...
    <div className="row between" style={{ marginBottom: 6 }}>
      ...
      <div className="row" style={{ gap: 2 }}>
        {/* A barbell lift's weight is what to load, not just what to type — the calculator
            starts from whatever's heaviest so far this exercise. */}
        {mode === 'reps' && <button className="iconbtn" aria-label={t('Plate calculator')} onClick={() => plateCalcSheet(best || entry.sets[0]?.w || 0)}><Icon name="plate" /></button>}
