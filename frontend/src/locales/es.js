...
export default {
  ...
  // --- food diary ---
  'Food': 'Comida',
  'Daily nutrition log': 'Registro nutricional diario',
  'Nutrition targets': 'Objetivos nutricionales',
  'About this': 'Sobre esto',
  'Protein': 'Proteína',
  'Carbs': 'Carbohidratos',
  'Fat': 'Grasa',
  'Add your height, age and activity level to get a calorie & macro target grounded in your body and your weight goal.': 'Añade tu altura, edad y nivel de actividad para obtener un objetivo de calorías y macros basado en tu cuerpo y tu meta de peso.',
  'Set up targets': 'Configurar objetivos',
  'Logged': 'Registrado',
  'Add food': 'Añadir comida',
  'Nothing logged yet.': 'Nada registrado aún.',
  'Search or scan a barcode to add your first item.': 'Busca o escanea un código de barras para añadir tu primer alimento.',
  '{0} logged': '{0} registrado',
  'Calories': 'Calorías',
  'Grams': 'Gramos',
  'Add to log': 'Añadir al registro',
  'Scan barcode': 'Escanear código de barras',
  'Could not access the camera — check permissions, or search by name instead.': 'No se pudo acceder a la cámara — revisa los permisos, o busca por nombre en su lugar.',
  'Point the camera at the barcode.': 'Apunta la cámara al código de barras.',
  'Search food…': 'Buscar alimento…',
  'Searching…': 'Buscando…',
  'Search failed — check your connection and try again.': 'Búsqueda fallida — revisa tu conexión e inténtalo de nuevo.',
  'No match for that barcode — try searching by name': 'Sin coincidencias para ese código de barras — prueba a buscar por nombre',
  'Could not look that up — check your connection': 'No se pudo consultar eso — revisa tu conexión',
  'Used to work out a calorie and macro target from your body and your weight goal — tap the (i) on the Food screen for how.': 'Se usa para calcular un objetivo de calorías y macros a partir de tu cuerpo y tu meta de peso — toca el (i) en la pantalla de Comida para saber cómo.',
  'Height (cm)': 'Altura (cm)',
  'Age': 'Edad',
  'Sex (for the calorie formula)': 'Sexo (para la fórmula calórica)',
  ...
  'Light exercise 1–3 days a week': 'Ejercicio ligero 1–3 días a la semana',
  'Moderate': 'Moderado',
  'Moderate exercise 3–5 days a week': 'Ejercicio moderado 3–5 días a la semana',
  'Active': 'Activo',
  'Hard exercise 6–7 days a week': 'Ejercicio intenso 6–7 días a la semana',
  'Very active': 'Muy activo',
  'Hard daily exercise plus a physical job': 'Ejercicio intenso diario más un trabajo físico',
  'Nutrition targets updated': 'Objetivos nutricionales actualizados',
  'Your calorie & macro target': 'Tu objetivo de calorías y macros',
  'Resting energy comes from the Mifflin-St Jeor equation — found unbiased and the most accurate of the standard predictive formulas against measured metabolic rate. Your activity level scales that up to a daily total.': 'La energía en reposo viene de la ecuación de Mifflin-St Jeor — la fórmula predictiva estándar más precisa y sin sesgo frente a la tasa metabólica medida. Tu nivel de actividad la escala hasta un total diario.',
  'The calorie target': 'El objetivo de calorías',
  'that total, adjusted by 0.7% of your body weight a week toward your goal — the rate that built or preserved muscle in a head-to-head trial against a faster rate in trained athletes. Never set below what your body burns at rest.': 'ese total, ajustado un 0,7% de tu peso corporal a la semana hacia tu meta — el ritmo que, en un ensayo comparativo con atletas entrenados, generó o preservó músculo frente a un ritmo más rápido. Nunca se fija por debajo de lo que tu cuerpo quema en reposo.',
  'Protein and fat': 'Proteína y grasa',
  'protein sits inside the range sports-nutrition research supports for holding onto muscle — higher while your target is below maintenance — and fat is never let drop below what hormonal health needs. Carbs fill whatever is left.': 'la proteína se mantiene dentro del rango que respalda la investigación en nutrición deportiva para conservar músculo — más alta mientras tu objetivo esté por debajo del mantenimiento — y la grasa nunca baja de lo que necesita la salud hormonal. Los carbohidratos cubren lo que queda.',
  'Right now: resting {0} kcal · daily total {1} kcal.': 'Ahora mismo: en reposo {0} kcal · total diario {1} kcal.',
}
